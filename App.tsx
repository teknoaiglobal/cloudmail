    ...
    const fetchFirestore = async () => {
      try {
        ...
        if (apiKeyMatch && zoneIdMatch && accountIdMatch) {
          ...
          // Update credentials otomatis jika berbeda dari yang tersimpan, atau jika belum ada
          if (!credentials || credentials.apiKey !== newCreds.apiKey || credentials.zoneId !== newCreds.zoneId) {
